#!/usr/bin/python3
"""A module that contains a function `validUTF8`"""


def validUTF8(data):
    """ Checking if all data within the list is a valid UTF8 encoding
    ...
    i = 0
    while i < len(data):
        # Checks for single-byte character
        if data[i] & 0x80 == 0x00:
            i += 1
        # Checks for multi-byte character
        # 2-byte sequence
